...
public class Door extends GameObject {
    ...
    public Door(Material material, boolean rotated) {
        ...
        if (mesh == null) {
            ...
            PrimitiveModel3D primitive = new PrimitiveModel3D(Primitive3D.box, 1f, 1f, 0.1f,
                    genDoorTexCoords(texCoords));
    ...
    public void update(float delta) {
        ...
        if (isOpening) {
            ...
            if (time < openTime) {
                ...
                // getTransform().setPos(closedPos.lerp(openPos, (float) (openTime - delta)
                // /(float) TIME_TO_OPEN));

...
public class Camera extends GameComponent {
    ...
    public Camera() {
        ...
        this((float) Math.toRadians(70.0f), (float) CoreEngine.getWidth() / (float) CoreEngine.getHeight(), 0.01f,
                1000.0f);
    ...
    public Matrix4x4 getViewProjection() {
        ...
        Matrix4x4 cameraTranslation = new Matrix4x4().initTranslation(cameraPos.getX(), cameraPos.getY(),
                cameraPos.getZ());

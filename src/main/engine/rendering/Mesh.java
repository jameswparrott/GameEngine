...
public class Mesh {
    ...
    // This method calculates VERTEX NORMALS, for smooth shading. Lighting effects
    // will be "weird" on low poly meshes
    ...
    private void calcTangents(Vertex[] vertices, int[] indices) {
        ...
        for (int i = 0; i < indices.length; i += 3) {
            ...
            Vector3D tangent = new Vector3D(dv2 * e1.getX() - dv1 * e2.getX(), dv2 * e1.getY() - dv1 * e2.getY(),

...
public class PrimitiveModel2D {
    ...
    public PrimitiveModel2D(Primitive2D primitive, Vector3D pos, float width, float height, boolean x, boolean y,
            boolean z, boolean flip) {
    ...
    public PrimitiveModel2D(Primitive2D primitive, Vector3D pos, float width, float height, boolean x, boolean y,
            boolean z, boolean flip, float[] texCoords) {
    ...
    private Mesh generate2D(Primitive2D primitive, Vector3D pos, float width, float height, boolean x, boolean y,
            boolean z, boolean flip, float[] texCoords) {
    ...
    private Mesh generateTri(Vector3D pos, float width, float height, boolean x, boolean y, boolean z, boolean flip,
            float[] texCoords) {
...
//		indices.add(2);
        ...
        if (x && y) {
            ...
            vertices.add(new Vertex(pos.add(new Vector3D(width / 2, -height / 2, 0)),
                    new Vector2D(texCoords[1], texCoords[2])));

            vertices.add(new Vertex(pos.add(new Vector3D(0, height / 2, 0)),
                    new Vector2D((texCoords[1] - texCoords[0]) / 2f, texCoords[3])));
            ...
            vertices.add(new Vertex(pos.add(new Vector3D(0, -height / 2, width / 2)),
                    new Vector2D(texCoords[1], texCoords[2])));
            ...
            vertices.add(new Vertex(pos.add(new Vector3D(width / 2, 0, -height / 2)),
                    new Vector2D(texCoords[1], texCoords[2])));

            vertices.add(new Vertex(pos.add(new Vector3D(0, 0, height / 2)),
                    new Vector2D((texCoords[1] - texCoords[0]) / 2f, texCoords[3])));
    ...
    private Mesh generateRect(Vector3D pos, float width, float height, boolean x, boolean y, boolean z, boolean flip,
            float[] texCoords) {
        ...
        if (x && y) {
            ...
            vertices.add(new Vertex(pos.add(new Vector3D(-width / 2, height / 2, 0)),
                    new Vector2D(texCoords[0], texCoords[3])));

            vertices.add(new Vertex(pos.add(new Vector3D(width / 2, height / 2, 0)),
                    new Vector2D(texCoords[1], texCoords[3])));
    ...
    private Mesh generateCircle(Vector3D pos, float width, float height, boolean x, boolean y, boolean z, boolean flip,
            float[] texCoords) {
        ...
        for (int i = 0; i <= CIRCLE_PRECISION; i++) {
            ...
            // vertices.add(new Vertex(new Vector3D(cos, sin, 0).scale(radius), new
            // Vector2D(xTex, yTex)));

...
public class AudioBuffer {
    ...
    public AudioBuffer(String file) {
        ...
        try (STBVorbisInfo info = STBVorbisInfo.malloc()) {
            ...
            alBufferData(id, info.channels() == 1 ? AL_FORMAT_MONO16 : AL_FORMAT_STEREO16, pulseCodedModulation,
                    info.sample_rate());
    ...
    private ShortBuffer readVorbis(String file, int capacity, STBVorbisInfo info) throws IOException {
        ...
        try (MemoryStack stack = MemoryStack.stackPush()) {
            ...
            if (decoder == 0)
                throw new RuntimeException("Failed to open " + file + " Vorbis: " + error.get(0));
            ...
            pulseCodedModulation.limit(
                    stb_vorbis_get_samples_short_interleaved(decoder, channels, pulseCodedModulation) * channels);
